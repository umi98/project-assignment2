...
class TaskController extends Controller {
	...
	public function updateTask(Request $request, $idTask)
	{
		$request->validate([
			'title'=>'string',
			'description'=>'string',
	...
	// TODO: assignTask()
	public function assignTask(Request $request, $idTask)
	{
		$request->validate([
			'assigned'=>'required'
		]);
	...
	// TODO: unassignTask()
	public function unassignTask($idTask)
	{
		$taskId = $idTask;
		$existTask = $this->taskService->getById($taskId);
	...
	// TODO: createSubtask()
	public function createSubtask(Request $request,$idTask)
	{
		$request->validate([
		...
		$this->taskService->addSubTask($existTask, $formData);
		$task = $this->taskService->getById($taskId);
		return response()->json($task);
	}
