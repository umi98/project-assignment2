...
class TaskRepository
{
	...
	/**
	 * Untuk mmenghapus task
	 *  */
	public function deleteTask(string $deletedId)
	{
		$id = $this->tasks->deleteQuery(['_id'=>$deletedId]);
		return $id;
	}

	/**
	 * Untuk melakukan assign dan unassign, saya menggunakan method save di kelas ini
	 *  */

	/**
	 * Untuk melakukan tambah sub tasks dan hapus sub tasks, saya menggunakan method save di kelas ini
	 *  */
}